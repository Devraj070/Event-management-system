...
//             console.log('Stored userId:', sessionStorage.getItem('userId')); // Log userId to confirm it's stored
...
//                     </div>
//                     <div className="flex justify-between text-sm float-end">
...
//                     <button onClick={() => alert('Google login clicked')} className="flex items-center justify-center bg-red-500 text-white py-2 rounded-md hover:bg-red-600 focus:outline-none focus:bg-red-600">
//                         <FontAwesomeIcon icon={faGoogle} className="mr-2" />
//                         Login with Google
//                     </button>
//                     <button onClick={() => alert('Facebook login clicked')} className="flex items-center justify-center bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700 focus:outline-none focus:bg-blue-700">
        ...
        <>
            <div className="flex justify-center items-center min-h-screen bg-gray-600">
                ...
                <div className="bg-white p-10 rounded-lg shadow-lg w-full max-w-md">
                    ...
                    <div className="grid grid-cols-1 gap-4 mt-6">
                        <button onClick={() => toast.error('Admin says: This feature is in progess!! try manual Login')} className="flex items-center justify-center bg-red-500 text-white py-2 rounded-md hover:bg-red-600 focus:outline-none focus:bg-red-600">
                            <FontAwesomeIcon icon={faGoogle} className="mr-2" />
                            Login with Google
                        </button>
                        <button onClick={() => toast.error('Admin says: This feature is in progess!! try manual Login')} className="flex items-center justify-center bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700 focus:outline-none focus:bg-blue-700">
                            <FontAwesomeIcon icon={faFacebook} className="mr-2" />
                            Login with Facebook
                        </button>
                    </div>
